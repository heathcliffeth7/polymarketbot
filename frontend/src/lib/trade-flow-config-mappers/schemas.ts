...
export const NODE_FIELD_SCHEMAS: Record<string, NodeFieldSchema[]> = {
  ...
  'action.place_order': [
    ...
    },
    {
      ...
      input: 'checkbox',
      help: 'Underlying Chainlink/PTB directional gap belirtilen esige indiginde ek bir hard full-close PTB stop-loss child sell orderi olusturur. Pair lock modunda bu alan ana bacagi kontrol eder.',
    },
    { key: 'slPriceCent', label: 'SL Fiyat (cent)', input: 'number', help: 'Hard full-close SL seviyesi. Tetiklenirse o andaki kalan pozisyonun tamami kapanir; staged SL satirlariyla birlikte kullanilabilir.' },
    {
      ...
      label: 'PTB Gap Esiği',
      input: 'number',
      help: 'Secili birime gore PTB gap degeri. Up/Yes icin current Chainlink - PTB, Down/No icin PTB - current Chainlink.',
    },
    {
    ...
    },
    {
      ...
      input: 'checkbox',
      help: 'Karsi bacak icin bagimsiz PTB hard stop-loss child orderi acar.',
    },
    {
      key: 'counterLegPtbStopLossGapUsd',
      label: 'Karsi Bacak PTB Gap Esiği',
      input: 'number',
      help: 'Karsi bacak PTB gap degeri. Secili birime gore yorumlanir.',
    },
    {
