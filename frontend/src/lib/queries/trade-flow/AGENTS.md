...
- Varsayilan ayirim eksenleri: `trigger.market_price`, `trigger.open_positions`, `trigger.position_drawdown`, `action.resolve_market`, `action.place_order`.
...
- Yeni veya dokunulan query/validation dosyalari 1500 satiri asmamali; 1400+ satirda once extraction, sonra yeni kural ekleme uygula.
